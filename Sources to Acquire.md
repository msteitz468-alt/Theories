# Sources to Acquire — wiki gap analysis

> Compiled 2026-06-21. The corpus (82 sources) is deep on the "alternative" side
> (UFO, NWO/finance, esoteric, ancient-astronaut, consciousness) but **almost
> one-voiced** — only Jacobsen and Heckethorn act as skeptical/scholarly anchors.
> The two biggest gaps: (1) skeptical & mainstream-scholarly counterweights, and
> (2) the foundational primary texts the existing books all cite but don't hold.
> Tick items off as you acquire them.

---

## Priority 1 — Skeptical & scholarly counterweights (highest value)
*Would give nearly every existing comparison a genuine opposing voice.*
...
- [x] **Kathryn Olmsted — *Real Enemies*** — historian on real vs. imagined U.S. government conspiracies *(ingested 2026-06-21 — 3-subagent split)*
...
- [X] **Aleister Crowley — *The Book of the Law* / *Magick in Theory and Practice*** — primary behind chaos magic & Enochian
...
- [X] **Zecharia Sitchin — rest of *The Earth Chronicles*** (you have only *The Twelfth Planet*) *(ingested 2026-06-22: Stairway to Heaven, Wars of Gods and Men, Lost Realms, When Time Began, There Were Giants Upon the Earth — 10-agent split. Complete Works .mobi compilation skipped as redundant/mixed-language.)*
...
- [ ] **Joseph Campbell — *The Hero with a Thousand Faces*** — comparative mythology tying the gods/demons/grail material together
- [ ] **Mircea Eliade — *Shamanism*** (or *The Sacred and the Profane*)

---

## Deprioritized — low ROI for a claims wiki
- **Jacques Vallée — *Forbidden Science* journals, vols 1–6** (in `raw-sources/`) and *Dimensions* / *Confrontations*. His core doctrine (interdimensional control system, disinformation, folklore continuity) is **already fully ingested** from *Magonia*, *The Invisible College*, and *Messengers of Deception*. The journals are personal diaries — low claim-density; they'd add firsthand *events/persons/history* (the Pentacle Memo, specific cases) but no new doctrine. **Park them; revisit later only as a single targeted pass** for the few genuinely novel firsthand episodes, not a full ingest.

### Recommended order
1. **Lead with Priority 1** — even 3–4 (Sagan, Barkun, Hofstadter, Colavito) turn the wiki from a one-sided archive into a balanced claims database and supercharge the controversy/comparison layer.
2. **Then Priority 2** — the primary roots, so claims can cite their sources.
3. **Free now:** the Vallée *Forbidden Science* journals already sit in `raw-sources/`.
