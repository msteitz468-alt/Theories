...
location: "[[Guatama (America)]]"
key_claims: []
sources_ingested: 1
last_updated: 2026-06-08
tags: ['event', 'topic/oahspe', 'event/revelation']
---
...
distances from one another" (see [[The Kosmon Revelation Was Given Simultaneously to Many]]). Its declared aim is "to teach
mortals HOW TO ATTAIN TO HEAR THE CREATOR'S VOICE, and to SEE HIS HEAVENS... whilst
still living" ([[Oahspe Aims to Teach Mortals to Hear the Creator and See the Heavens While Living]]). The text is attributed on its title page to
[[John Ballou Newbrough]] and was, per its own framing, written in [[Guatama (America)]], the
land "untrammeled with Gods and Saviors... enforced by the sword" ([[Kosmon Was Revealed in a Land Free of Enforced Gods and Saviors]]).
