...
tags: [comparison, topic/conspiracy, topic/alternate-history]
---
...
```mermaid
graph TD
    Sitchin["Zecharia Sitchin<br>(The Twelfth Planet, 1976)"] -->|Anunnaki & Genetic creation| Icke["David Icke<br>(The Biggest Secret, 1999)"]
    Sitchin -->|Sumerian translations| Wallis["Paul Wallis<br>(Eden Series, 2020-2022)"]
    Bramley["William Bramley<br>(The Gods of Eden, 1990)"] -->|Custodial Alien Society| Icke
    Gnostics["Ancient Gnostic Texts<br>(Nag Hammadi)"] -->|Archons as mind parasites| Icke
    Grail["Baigent, Leigh, Lincoln<br>(Holy Blood & Holy Grail, 1982)"] -->|Merovingian/Jesus Bloodlines| Icke
    Icke -->|Plasma Matrix Simulation| IckeReveal["David Icke<br>(The Reveal, 2024)"]
    Wallis -->|Elohim & Sky People| WallisScars["Paul Wallis<br>(The Scars of Eden, 2021)"]
```
...
```mermaid
graph TD
    Mullins["Eustace Mullins<br>(Secrets of the Federal Reserve, 1952/1985)"] -->|Jekyll Island & London Rothschild connection| Griffin["G. Edward Griffin<br>(Creature from Jekyll Island, 1994)"]
    Mullins -->|Fed Secrecy & War Financing| Marrs["Jim Marrs<br>(Rule by Secrecy, 2000)"]
    Griffin -->|Hegelian Dialectic & Mandrake Mechanism| Marrs
```
...
```mermaid
graph TD
    Quigley["Carroll Quigley<br>(Tragedy and Hope, 1966)"] -->|Rhodes-Milner Round Table & CFR| Coleman["John Coleman<br>(The Club of Rome, 2008)"]
    Quigley -->|RIIA & Anglo-American Establishment| Marrs["Jim Marrs<br>(Rule by Secrecy, 2000)"]
    Meadows["Meadows et al.<br>(Limits to Growth, 1972/2004)"] -->|Resource exhaustion study| Coleman
    Coleman -->|Committee of 300 / Genocidal agenda| Cooper["William Cooper<br>(Behold a Pale Horse, 1991)"]
    Cooper -->|MJ-12 & UFO Coverup integration| NWO["Modern NWO Synthesis"]
```
