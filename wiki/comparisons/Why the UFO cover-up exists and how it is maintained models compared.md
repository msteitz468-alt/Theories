---
title: "Why the UFO cover-up exists and how it is maintained models compared"
aliases:
  - "Why the UFO cover-up exists and how it is maintained models compared"
  - "UFO secrecy and cover-up models compared"
type: comparison
related_sources:
...
tags: [comparison, topic/ufo-disclosure, topic/ufo-coverup, cross-source]
---

## Overview

Nearly every UFO source in the wiki agrees there is *official secrecy* around the subject — but they
disagree sharply about **why it exists** and **how it is maintained**. This page compares the
*secrecy* itself, a different cut from
[[Competing models of the UFO phenomenon compared across sources]], which compares what the
phenomenon *is*. Each position is attributed and **not adjudicated**.
...
| **Elizondo** | Yes (insider) | Security + bureaucratic stigma | A seven-step "playbook"; selective declassification |
| **Coulthart** | Yes (insider sourcing) | Concealing retrieved materials/legacy programs | Defense-contractor concealment; witness intimidation |
| **Kean** | Avoidance more than conspiracy | Institutional risk-aversion and ridicule | Official avoidance; no agency to investigate |
| **Vallée** | Yes — *but the cover-up is itself a psyop* | Manipulation of belief; a "control system" | Disinformation seeded into believer culture |
| **Pasulka** | Yes, but largely cultural | Religious-shock fear + intelligence interest | Media/confirmation-bias suppression |

## Where they converge

1. **There is official secrecy/avoidance** — from Dolan's
...
- **The motive.** *National security / protect technology* (Dolan, Elizondo, Kean) vs *elite control by
  a hidden government* (Cooper) vs *the secrecy is disinformation/psyop* (Vallée) vs *cultural and
  religious suppression more than conspiracy* (Pasulka, Kean).
- **What is actually being hidden.** Real non-human craft (Dolan, Good, Cooper, Coulthart, Elizondo) vs
  *secret human aircraft and a Soviet hoax mistaken for UFOs* (Jacobsen) vs an interdimensional
  [[The control system (Vallée's functioning lie)|control system]] using the phenomenon *and* the
  cover-up (Vallée).
- **Conspiracy vs drift.** A deliberate, coordinated cover-up (Cooper, Dolan) vs institutional
  avoidance and ridicule that *functions* as one without central direction (Kean, Pasulka).
