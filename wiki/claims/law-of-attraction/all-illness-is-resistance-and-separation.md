---
title: "All Illness Is Vibrational Resistance and Separation From the Inner Being"
type: claim
...
contexts: ['Book 2, Part III — Physical Well-Being']
prevalence_in_source: "the foundational health claim, asserted without exception"
status: extracted
...
Abraham says medicine and doctors are "neither good nor bad," and that action "accompanied by joy or love" (e.g. a doctor visit) "is always valuable" — it is action from fear that is not.
