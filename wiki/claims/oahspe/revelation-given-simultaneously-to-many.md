...
involved_actors:
  - type: source
    link: "[[Oahspe: A New Bible (Newbrough, 1882)]]"
source_attribution: "[[Oahspe: A New Bible (Newbrough, 1882)]]"
contexts: ["Oahspe (opening proclamation), v. 25"]
prevalence_in_source: "the source's account of its own non-exclusive revelation"
status: extracted
