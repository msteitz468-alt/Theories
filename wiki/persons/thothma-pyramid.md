...
also_known_as: ["Hojax"]
roles:
  - "Egyptian adept and king"
  - "builder of the great pyramid (per Oahspe)"
textual_sources:
...
old." He exemplifies high [[Su'is and Sar'gis (clairvoyance and materialization)]] turned to the service of a false God.
