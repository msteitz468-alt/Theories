...
prototype is [[Anuhasaj (De'yus, the false Lord God)]] (De'yus). The progression is always the same:
...
- Driven by **Satan**, defined in the Glossary as "the captain of the selfish
  passions. Selfishness per se. Self." (see [[The Beast (Self) and Its Four Heads]], [[Self Is the Satan That Is the Origin of All False Gods]]).
- False Gods demand worship, set up counterfeit heavens (a false [[Hored (the first heaven of the earth)]]),
  appoint "Saviors" (Anubi), and drive men to war.
- The great false Gods include De'yus, Osiris, Te-in, Sudga, Baal, Ashtaroth, and
  the four founders of the world religions ([[The Confederacy of the Holy Ghost (the Triunes)]]).
- All are eventually "cast into hell."

## Related Concepts

- [[The Beast (Self) and Its Four Heads]], [[God, Lords, and the Hierarchy of Heaven]], [[The Confederacy of the Holy Ghost (the Triunes)]], [[The Rejection of Vicarious Salvation]]
