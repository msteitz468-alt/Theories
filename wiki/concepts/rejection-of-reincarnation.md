...
- Spiritual progress is by resurrection upward through the heavens, not by return
  to flesh (see [[The Three Resurrections and the Grades of Ascent]]).
- Spirits who claim reincarnation are among the deceiving drujas of the first
  resurrection (see [[Drujas, Fetals, and the Bondage of Hells]]).
- A spirit that obsessively re-attaches to mortals is a fetal/vampire, not a
  reborn soul.

## Related Concepts

- [[The Three Resurrections and the Grades of Ascent]], [[The Tree of Life and the Origin of Immortal Man]], [[Drujas, Fetals, and the Bondage of Hells]]
