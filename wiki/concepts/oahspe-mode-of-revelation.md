...
remote distances from one another" (see [[The Kosmon Revelation Was Given Simultaneously to Many]]). Its aim is practical —
...
- The Book of Discipline warns that both wise and false angels speak to mortals,
  ...
  names professed.
- It is given in [[Guatama (America)]] (America) precisely because that land is "free"
  of enforced state religion (see [[Kosmon Was Revealed in a Land Free of Enforced Gods and Saviors]]).
- The revelation includes new "science" (vortexya) deliberately "at variance"
  with established astronomy.

## Related Concepts

- [[The Doctrine of Inspiration (Oahspe)]], [[The Kosmon Era]], [[The Kosmon Revelation (the writing of Oahspe)]]
