#!/usr/bin/env python3
"""Bulk-create wiki pages for Jacques Vallée — *Passport to Magonia* (1969).

Strict-extraction ingest. Vallée's argument is explicitly that he is NOT
asserting the objects are physical; that agnosticism is part of the source and
is preserved on the pages.

Templates are flush-left (no textwrap.dedent) so multi-line YAML blocks keep
valid 2/4-space nesting.
"""
...
status: extracted
last_updated: {TODAY}
tags: [claim, source/vallee-1969, topic/{TOPIC}]
---
...
if __name__ == "__main__":
    import ingest_magonia_data as data
    g = dict(globals())
